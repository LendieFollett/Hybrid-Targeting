...
#Note: Input data currently must be ordered by community, person within community
...
j=0
for ( idx in 1:K){ #loop over communities
  for (idx2 in 1:(R/K)){ #loop over ranker within community
    j = j + 1
